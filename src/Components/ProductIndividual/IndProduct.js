...
function IndProduct({data,handlecartclick,handleFavclick}){
    ...
    return(
        ...
        <div className='cloth-info'> 
            ...
            <div className='heart-icon'>
                <svg onClick={()=>handleFavclick(data)}  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-suit-heart" viewBox="0 0 16 16">
            ...
            <p className='para-info'>{data.title}</p>
