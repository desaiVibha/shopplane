        ...
        <div className='topHome-main'>
            ...
            <div className='right-section-top'>
                ...
                <div className='cart-symbol'>
                    <svg className='cart-hover' onClick={()=>{setShow(false);setfavState(false);setclickProd(false); data(false);
        datas(false); setvisitFav(false);}} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
